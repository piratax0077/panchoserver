@if($dia->count()>0)
Operaciones del día {!!\Carbon\Carbon::parse($fecha)->format("d-m-Y")!!}; monto: {{number_format(intval($total_dia),0,',','.')}} <a href="/reportes/imprimir_detalle_dia_getnet/{{$fecha}}" class="btn btn-success btn-sm" ><i class="fa-solid fa-file-excel"></i></a><br><br>
