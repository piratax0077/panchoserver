    ...
    <div class="row" >
        <div class="col-sm-12">
            <table border="0" class="table table-sm letra-chica">
                <thead>
                    <th width="35%" scope="col"><center>Forma de Pago</center></th>
                    <th width="25%" scope="col"><center>Monto</center></th>
                    <th width="40%" scope="col"><center>Referencia</center></th>
                </thead>
                <tbody>
...
@else
    ...
    <div class="alert alert-info">
        <h4><center>Ingrese Formas de Pago en la BD...</center></h4>
    </div>
    </div>
@endif
