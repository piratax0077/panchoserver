        ...
        <div class="row" style="margin-top:10px">
          ...
          <div class="col-md-6">
            <label for="modelo">Modelo:</label>
  		    ...
  		    <div class="col-md-6">
            <label for="MarcaRepuesto">Marca Repuesto:</label>
...
<div class="row" style="margin-top:10px">
          ...
          <div class="col-md-6">
            ...
            <select name="cboPais" class="form-control" id="Pais">
...
<!-- FILA PARA LA INGRESAR LA DESCRIPCIÓN -->
        ...
        <div class="row" style="margin-top:10px">
          ...
          <div class="col-md-6">
            <label for="codigo_barras">Cód. Repuesto2:</label>
        ...
        <div class="row" style="margin-top:10px">
          <div class="col-md-6">
            <label for="codigo_barras">Cód. Barras:</label>
        ...
        <div class="row" style="margin-top:10px">
          ...
          <div class="col-md-6">
            <label for="precio_venta">Precio Sugerido:</label>
