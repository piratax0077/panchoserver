...
class otrolugar_controlador extends Controller
{
   ...
   private $marcas;
    ...
    public function index()
    {
        ...
        return view('errors.otrolugar',compact('marcas'));
    ...
    public function store(Request $request)
    {
        ...
        if(isset($request->btnGuardarMarcaVehiculo))
        {
            ...
            */
            ...
            $marcavehiculo->urlfoto=$archivo->store(base_path(),'custom'); //ESTA PARTE MODIFICAR, NO FUNCIONA CON EL DISK CUSTOM
            ...
            $marcas=$this->damemarcas();
            return view('errors.otrolugar',compact('marcas'))->with('msgGuardado','Marca Guardada');


        }else{
            return "No es el boton";
        }
    }
    ...
    public function edit($id)
    {
        ...
        $app=app_path();
        $rutas="base: ".$base."  public: ".$public." storage: ".$storage." app: ".$app;


        return view('fragm.mensajes')->with('msgGuardado',$rutas);
    }
    ...
    public function destroy($id)
    {
        ...
        $marcas=$this->damemarcas();
        return view('errors.otrolugar',compact('marcas'))->with('msgGuardado','Marca Eliminada.');
    }
