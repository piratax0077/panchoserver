...
class LibroCompraVenta extends Libro
{
    ...
    public function setCaratula(array $caratula)
    {
        ...
        $this->id = 'PR_LIBRO_'.$this->caratula['TipoOperacion'].'_'.str_replace('-', '', $this->caratula['RutEmisorLibro']).'_'.str_replace('-', '', $this->caratula['PeriodoTributario']).'_'.date('U');
    }
    ...
    public function getResumen()
    {
        ...
        //Debugbar::info($totales);
        //Ajustar Neto e IVA en base al Monto Total
        $totales[33]['TotMntNeto']=round($totales[33]['TotMntTotal']/1.19,0);
        $totales[33]['TotMntIVA']=$totales[33]['TotMntTotal']-$totales[33]['TotMntNeto'];
        $totales[39]['TotMntNeto']=round($totales[39]['TotMntTotal']/1.19,0);
        $totales[39]['TotMntIVA']=$totales[39]['TotMntTotal']-$totales[39]['TotMntNeto'];
        $totales[61]['TotMntNeto']=round($totales[61]['TotMntTotal']/1.19,0);
        $totales[61]['TotMntIVA']=$totales[61]['TotMntTotal']-$totales[61]['TotMntNeto'];
        /*
        Debugbar::info("FACTURAS Total: ".$totales[33]['TotMntTotal']." Neto: ".$totales[33]['TotMntNeto']." IVA: ".$totales[33]['TotMntIVA']);
        Debugbar::info("BOLETAS Total: ".$totales[39]['TotMntTotal']." Neto: ".$totales[39]['TotMntNeto']." IVA: ".$totales[39]['TotMntIVA']);
        Debugbar::info("N.CRED Total: ".$totales[61]['TotMntTotal']." Neto: ".$totales[61]['TotMntNeto']." IVA: ".$totales[61]['TotMntIVA']);
        */
        // entregar resumen
        ksort($totales);
        return $totales;
