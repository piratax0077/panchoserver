...
class ClsSii_online
{
    ...
    public static function generar_xml($Receptor,$Detalle,$Datos)
    {
        ...
        if($Datos['tipo_dte']=='39')
        {
            ...
            $documento=FormatosDocSii_online::dameBoleta($Receptor,$Detalle,$Datos);
        ...
        {
            $documento=FormatosDocSii_online::dameFactura($Receptor,$Detalle,$Datos);
        ...
        {
            $documento=FormatosDocSii_online::dameNotaCredito($Receptor,$Detalle,$Datos);
        ...
        {
            $documento=FormatosDocSii_online::dameGuiaDespacho($Receptor,$Detalle,$Datos);
        ...
        {
            $documento=FormatosDocSii_online::dameNotaDebito($Receptor,$Detalle,$Datos);
        ...
        $caratula = [
                ...
                'FchResol' => "2014-08-22", //https://maullin.sii.cl/cvc_cgi/dte/ee_empresa_rut
                'NroResol' => intval(80),
            ];
